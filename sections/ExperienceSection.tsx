...
const ExperienceSection: React.FC = () => {
  ...
  return (
    ...
    >    <section id="Experience" className="section">
      ...
      <VerticalTimeline lineColor={theme.theme==='dark'?"#05ce91":"#007a7a"} >
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentArrowStyle={{ borderRight: "7px solid  rgb(33, 150, 243)" }}
          date="2011 - present"
          iconStyle={{ background: theme.theme==='dark'?"#007a7a":"#05ce91", color: "#fff" }}
          //   icon={<WorkIcon />}
        >
          <h3 className="text-xl">Creative Director</h3>
